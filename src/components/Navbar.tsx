...
function Navbar({ activeNavbar, setActiveNavbar }: NavbarProps) {
  ...
  return (
    <>
      {activeNavbar === 1 && (
        <div
          className={`fixed w-full flex flex-col items-center flextransition-all duration-300 z-50`}
        >
          <div
            className={`w-full h-[64px] bg-[#084a83]/30 flex justify-center transition-all duration-300 backdrop-blur-[5px] shadow-lg z-50`}
          >
          ...
          <div className="w-full max-w-[1148px] p-2">
            {/* Widget countdown sholat */}
