...
const workExperiences = [
  {
    ...
    description: [
      ...
      "Future-Proof Architecture: Established a clean and highly maintainable system base, empowering the next IT team to seamlessly maintain and continue development as part of PPI Curug's broader digital transformation.",
