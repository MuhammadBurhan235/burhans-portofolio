...
const workExperiences = [
  {
    ...
    description: [
      "Product: Training Application (Learning Management System-based) that digitalizes the registration process between PPIC and partner institutions and supports end-to-end training activities.",
      "As of Feb 18, 2026: designed the system architecture and database using an Entity Relationship Diagram (ERD).",
      "Created flowcharts for business processes and system flows.",
      "Designed the entity structure and data relationships.",
