...
const workExperiences = [
  {
    ...
    description: [
      ...
      "Future-Proof Architecture: Established a clean and highly maintainable system base, empowering the next IT team to seamlessly execute future updates and re-engineering as part of PPI Curug's broader digital transformation.",
  ...
  },
  {
    ...
    description: [
      "Tech Stack: PHP, MySQL, JavaScript, SCSS, Moodle (LMS), WordPress, Open Journal System (OJS), VPS Management, Web Security, System Architecture (ERD), Git.",
      "LMS Development: Designed and developed ATLAS (Aviation Training & Learning Application System), an end-to-end Moodle-based application to digitalize the registration and training processes between PPIC and partner institutions. The scope covered business process mapping through flowcharts, system architecture, database design (ERD), and deployment on Hostinger web hosting.",
      "Custom Moodle Plugin Development: Engineered an All-in-1 Flow feature and built a standalone centralized scheduling system plugin for Moodle. This streamlined training management workflows and replaced manual spreadsheet-based tracking.",
      "System Security & Audit (OJS): Maintained the institutional journal platform (journal.ppicurug.ac.id) through version upgrades and frontend re-engineering, then conducted analytical security audits to identify and mitigate SQL Injection and Code Injection vulnerabilities in the database layer.",
      "Server Management (VPS): Managed the VPS environment independently through terminal access, covering system configuration, file manager maintenance, database administration, and routine data backups.",
      "Deployment Automation & Hosting: Built an automated migration flow from local staging to production using FTP integrated with GitHub and VS Code, and handled domain and hosting procurement plus configuration.",
      "Problem Solving & Collaboration: Worked closely with the team to analyze system requirements, support technical decision-making, and present solutions clearly to stakeholders.",
      "Preview Link: https://pelatihan.overthinkingku.com/",
    ],
    location:
