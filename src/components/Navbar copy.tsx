...
// // Tambahkan di atas jika pakai react-responsive
...
//       if (width < 700) setVisibleCount(1);
...
//           text-sm md:text-base cursor-pointer whitespace-nowrap
//           ${
//             active === sec.id
//               ? "bg-blue-600 text-white"
//               : "bg-white text-blue-600 hover:bg-blue-100"
...
//                           offset={-64}
//                           duration={500}
//                           className={`px-3 py-2 rounded-md nav-link transition-colors duration-200 text-sm cursor-pointer whitespace-nowrap
//                   ${
//                     active === sec.id
//                       ? "bg-blue-600 text-white"
//                       : "bg-white text-blue-600 hover:bg-blue-100"
...
//             </div> */}
//           </div>
//           {/* <div className={`fixed right-1 items-center justify-center min-[441px]:hidden transition-all duration-300 ${showNavbar ? "bottom-[72px]" : "bottom-[52px]"}`}>
//             <a
//               href=""
//               className={`h-[44px] px-4 py-2 bg-blue-600 border-2 border-blue-600 rounded-[8px] text-white flex gap-3 items-center hover:bg-white hover:border-2 transition-all duration-300 group ${showNavbar ? "w-[163px]" : "w-[53px] "}`}
//             >
//               <span className="text-lg">
//                 <FaPencilAlt />
//               </span>
//               <p
//                 className={`text-base text-white font-medium items-center whitespace-nowrap group-hover:text-blue-600 transition-all duration-300 ${showNavbar ? "block" : "hidden"}`}
//               >
//                 Buat Laporan
//               </p>
//             </a>
